...
| `wcag22:1.3.1` | Info and Relationships | A | partial | aria/icon-child-missing-aria-hidden, aria/icon-font-hidden +30 | otp-input-cluster | **rule** |
...
| `wcag21:1.3.1` | Info and Relationships | A | partial | aria/icon-child-missing-aria-hidden, aria/icon-font-hidden +30 | otp-input-cluster | **rule** |
...
| `section508:1.3.1` | Info and Relationships | base | partial | aria/icon-child-missing-aria-hidden, aria/icon-font-hidden +30 | otp-input-cluster | **rule** |
...
| `en301549:9.1.3.1` | Info and Relationships | base | partial | aria/icon-child-missing-aria-hidden, aria/icon-font-hidden +30 | otp-input-cluster | **rule** |
