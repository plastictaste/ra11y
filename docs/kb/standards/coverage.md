...
| `wcag22:3.3.2` | Labels or Instructions | A | full | forms/fieldset-legend, forms/label-adjacent-unassociated +7 | otp-input-cluster | **rule** |
...
| `wcag21:3.3.2` | Labels or Instructions | A | full | forms/fieldset-legend, forms/label-adjacent-unassociated +7 | otp-input-cluster | **rule** |
...
| `section508:3.3.2` | Labels or Instructions | base | full | forms/fieldset-legend, forms/label-adjacent-unassociated +7 | otp-input-cluster | **rule** |
...
| `en301549:9.3.3.2` | Labels or Instructions | base | full | forms/fieldset-legend, forms/label-adjacent-unassociated +7 | otp-input-cluster | **rule** |
