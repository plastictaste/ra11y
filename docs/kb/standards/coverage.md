...
| `wcag22:1.3.1` | Info and Relationships | A | partial | aria/icon-font-hidden, document/charset-first-1024-bytes +16 | — | **rule** |
...
| `wcag22:3.3.2` | Labels or Instructions | A | full | forms/fieldset-legend, forms/label-for-id-mismatch +4 | — | **rule** |
...
| `wcag22:4.1.2` | Name, Role, Value | A | partial | aria/conflicting-role, aria/expanded-on-disclosure +20 | — | **rule** |
...
| `wcag21:1.3.1` | Info and Relationships | A | partial | aria/icon-font-hidden, document/charset-first-1024-bytes +16 | — | **rule** |
...
| `wcag21:3.3.2` | Labels or Instructions | A | full | forms/fieldset-legend, forms/label-for-id-mismatch +4 | — | **rule** |
...
| `wcag21:4.1.1` | Parsing | A | manual | document/charset-first-1024-bytes, parsing/duplicate-id | — | **rule** |
| `wcag21:4.1.2` | Name, Role, Value | A | partial | aria/conflicting-role, aria/expanded-on-disclosure +20 | — | **rule** |
...
| `section508:1.3.1` | Info and Relationships | base | partial | aria/icon-font-hidden, document/charset-first-1024-bytes +16 | — | **rule** |
...
| `section508:3.3.2` | Labels or Instructions | base | full | forms/fieldset-legend, forms/label-for-id-mismatch +4 | — | **rule** |
...
| `section508:4.1.2` | Name, Role, Value | base | partial | aria/conflicting-role, aria/expanded-on-disclosure +20 | — | **rule** |
...
| `en301549:9.1.3.1` | Info and Relationships | base | partial | aria/icon-font-hidden, document/charset-first-1024-bytes +16 | — | **rule** |
...
| `en301549:9.3.3.2` | Labels or Instructions | base | full | forms/fieldset-legend, forms/label-for-id-mismatch +4 | — | **rule** |
...
| `en301549:9.4.1.2` | Name, Role, Value | base | partial | aria/conflicting-role, aria/expanded-on-disclosure +20 | — | **rule** |
