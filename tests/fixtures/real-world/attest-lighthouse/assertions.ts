 ...
 *   agent-bridge.ts        — TypeScript showing the Lighthouse → attest
 *                            mapping. This IS parsed by the scanner.
 *
...
export const assertions: FixtureAssertions = {
  description:
    "Lighthouse accessibility audit → attest bridge pattern: agent-bridge.ts compiles " +
    "cleanly with zero parse errors and emits no accessibility violations, confirming " +
